...
const API3 = "http://localhost:5164/homeView3";
...
const Home = () => {
  ...
  //         setItems1(responseData.rData.items);
  //         console.log("items:", responseData.rData.items);
  //       } else {
  //         console.log("No items data in response");
  //       }
  //     }
  //   } catch (error) {
      ...
      <MainLayout>
        <div className="home">
            ...
            <div className="trending-photo-card">
              {items2.map((item) => (
                <div className="trending-card" key={item.id}>
                  ...
                  <p className="trending-state">
                    <Link to={item.link} onClick={backToTop} className="link">
                      {item.heading}{" "}
                    </Link>
                  </p>
                </div>
          ...
          <div className="weekend">
            ...
            {items3.map((item) => (
              <div className="weekend-card" key={item.id}>
                <Link to={item.link} onClick={backToTop}>
                  <img src={`data:image/jpeg;base64,${item.image}`} alt="" />
                </Link>
                <p className="weekend-packages">{item.details}</p>
                <p className="weekend-state">
                  {" "}
                  <Link to={item.link} className="link" onClick={backToTop}>
                    {item.heading}
                  </Link>
                </p>
              </div>
            ...
            <div className="choose-cards">
              ...
              <div className="choose-card team">
                ...
                <p className="choose-card-details">
                  ...
                  within the mesmerizing landscape of India. Their knowledge is
                  an invaluable asset for every traveler.
                </p>
              </div>
              <div className="choose-card verified">
                ...
                <p className="choose-card-details">
                  We offer a meticulously selected and verified list of
                  high-grade hotels. Our partners consistently deliver top-notch
                  service, ensuring an exceptional experience for our guests.
                </p>
              </div>
              <div className="choose-card value">
                ...
                <p className="choose-card-details">
                  With Tour My India, your vacation is not just about
                  sightseeing; it's about creating memories that last a
                  lifetime. Our holiday packages are hassle-free and designed
                  with a focus on value for money. Trust us to weave
                  unforgettable experiences into your journey, ensuring every
                  moment you spend with us is well worth it.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="incredible-india">
            <div className="incredible-india-heading">
            ...
            <div className="incredible-india-details-pic">
              <div className="incredible-india-details">
                ...
                enthralling experience entails in the India wildlife tour
                packages that take tourists to the habitats of Royal Bengal
                Tigers, one-horned rhinos, and snow leopards amongst many rare,
          ...
          <div className="climate-visa">
            <div className="climate">
              ...
              <p className="climate-details">
                India experiences a diverse climate and weather conditions due
                to its vast size and geographical features. The country is
                characterized by five main seasons: Spring, Summer, Monsoon,
                Autumn, and Winter. The Summer season, from April to mid-June,
                brings scorching temperatures, especially in the northern
                plains. The Monsoon, from mid-June to September, brings heavy
                rainfall, crucial for agriculture. Winter, from November to
                February, varies from mild to severe cold, with snowfall in some
                regions. Autumn and Spring provide pleasant weather with
                moderate temperatures. India's climate is influenced by the
                Himalayas, oceans, and geographical variations, resulting in a
                rich and varied weather pattern.
              </p>
            </div>
            <div className="visa">
              ...
              <p className="visa-details">
                ...
                travelers planning to visit the country. India offers various
                visa categories, including tourist visas, business visas, and
                e-visas. The tourist visa allows visitors to explore India's
                rich cultural heritage, historical sites, and natural beauty.
                The e-visa is a convenient option that allows travelers to apply
                for their visa online, streamlining the process and reducing the
                wait time. To apply for an India visa, travelers need to submit
                necessary documents, such as a valid passport, travel itinerary,
                and recent photographs. Planning ahead and adhering to the
                application guidelines ensure a smooth visa process for a
                memorable trip to India. For the latest information about
                getting a visa for India, visit the official website at{" "}
          ...
          <div className="travel-info">
            <div className="best">
              ...
              <div className="best-details">
                ...
                <p>
                  The best time to visit India for holidays depends on the type
                  of experience you seek. The tourism season in India varies
                  across regions due to its diverse climate. The peak tourism
                  season in India starts from September to June. For wildlife
                  enthusiasts, winter is ideal as national parks are open, and
                  wildlife sightings are abundant. Hill stations are most
                  enjoyable during summer to escape the scorching heat of the
                  plains. For trekking and hiking adventures, winter, monsoon,
                  autumn, and spring offer pleasant weather. Plan your trip
                  according to your preferences, and you'll discover India's
                  incredible beauty and cultural richness, making it an
                  unforgettable holiday destination. September to April can be
                  considered an ideal time to explore India for tourism
                  holidays.
                </p>
              </div>
            </div>
            ...
            <div className="best">
              ...
              <div className="how-details">
                ...
                <p>
                  ...
                  accessible through various modes of transport, ensuring a
                  smooth entry for tourists from around the world. India boasts
                  an extensive road connectivity, making it convenient for
                  travelers to explore different regions. The rail network, with
                  an extensive network of trains, offers a scenic and
                  comfortable journey to various destinations.
                </p>
              </div>
            </div>
            <hr />
            ...
            <div className="best">
              ...
              <div className="must-details">
                ...
                <p>
                  ...
                  transportation, and staying safe. These tips will help you
                  make the most of your India tour and have a memorable
                  experience.
                </p>
              </div>
            </div>
