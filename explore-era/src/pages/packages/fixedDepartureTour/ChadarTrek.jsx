...
import './fixedDepartureTour.css'

const ChadarTrek = () => {
  return (
    <MainLayout>
      <div className="chadar-trek">
        <h1>
        ...
        <p>
          ...
          with an ultimate experience. Frozen river trek means you have to walk
          down frozen zanskar river. The traditional name of the trek is "Chadar
          trek" the frozen sheet, which was only way in and out for Zanskaris in
          winter when all other ways are closed due to heavy snow fall at high
          passes. Therefore, it had been trade route for centuries for Zanskari
          People. Now the route is also famous as winter trekking among
          adventure lovers. For last several years, we have been organizing this
          winter trek in three different options with trained local Zanskari
          potters and our well-experienced guide and staff.
        </p>

        <p>
          <span>Area:</span> Zanskar (Ladakh){" "}
        </p>
        <p>
          <span> Altitude: </span> 3850 mts/12628 ft{" "}
        </p>
        <p>
          <span> Grade: </span> Moderate to tough{" "}
        </p>
        <p>
          <span> Duration: </span> 13 days{" "}
        </p>
        <p>
        ...
        <p>
          ...
          in this area. <br />
          <br />
          Shey Gompa is about 15 kms from Leh. It used to be the summer palace
          of the kings of Ladakh. There are lots of Stupas and Gompas built
          around the palace. Shey palace was built by Deldan Namgyal in the
          beginning of 17'Th century AD. Main attraction in Shey is the 12m
          Shakyamuni Buddha statue inside the Dresthang Gompa. <br />
          <br />
          Thiksey Gompa, close to Shey is about 17 kms from Leh. The monastery
          is considered to be one of the most beautiful in Ladakh and belongs to
          the Gelukspa order. <br />
          <br />
          Hemis, about 45 kms south of Leh it is one of the most famous and
          largest monastery in Ladakh. It belongs to the Drukpa order and was
          founded in the early 17'Th century. The setting is perfect with the
          monastery cradled in a lovely valley, surrounded by streams and
