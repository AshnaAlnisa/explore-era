          ...
          <div className="content-wrapper">
            <div className="hero">
              <img
                ...
                src="images/goa-home-banner.webp"
                alt="Himachal Pradesh"
              />
            </div>
            <section className="intro">
              <h1>Goa Tourism</h1>
              <p>Picturesque Beaches, Good Vibes, and Adventure Await in Goa</p>

              <div className="cards">
                <div className="card">
                  <h2>Beaches</h2>
                  <p>Tourists can unwind themselves on the white sand beaches of Goa.</p>

                </div>
                <div className="card">
                  <h2>Adventure</h2>
                  <p>With endless options for adventure activities Goa gives you an ideal holiday experience.</p>

                </div>
                <div className="card">
                  <h2>Festivals</h2>
                  <p>Goa is the first choice of tourists when it comes to nightlife and festivities.</p>
